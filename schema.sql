CREATE DATABASE  IF NOT EXISTS `forest-network-db` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `forest-network-db`;
-- MySQL dump 10.13  Distrib 5.7.24, for Linux (x86_64)
--
-- Host: localhost    Database: forest-network-db
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `transactions_payment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
-- Dump completed on 2018-12-14 12:42:09
